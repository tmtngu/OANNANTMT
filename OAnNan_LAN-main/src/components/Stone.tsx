...
/* HÀM TẠO SỐ NGẪU NHIÊN THEO MẪU */
...
const Stone: React.FC<StoneProps> = ({ count, size = 'md', isQuan = false }) => {
  ...
  {/* KIỂM TRA ĐIỀU KIỆN HIỆN VIÊN QUAN LỚN */}
  const hasQuanVien = isQuan && count >= 10;

  {/* KHỞI TẠO VỊ TRÍ NGẪU NHIÊN CHO SỎI */}
